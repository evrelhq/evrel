...
use evrel_js_ir::{BlockId, FunctionEditor, JsFunctionIr, OperationId, ValueId};
use rustc_hash::{FxHashMap, FxHashSet};

use crate::js::analysis::{RegionControlFlowGraph, RegionDominanceFrontier, RegionDominatorTree};
...
mod tests {
    ...
    use crate::js::analysis::{
        RegionControlFlowGraph, RegionDominanceFrontier, RegionDominatorTree,
    };
