...
use crate::{
    ...
    FunctionProperties, ModuleExport, ModuleImport, ModuleIr, PrivateNameId, TemplateSiteId,
};
...
impl<'ir> ModuleBuilder<'ir> {
    ...
    pub fn new(module: &'ir mut ModuleIr) -> Self {
        Self { module }
    }
...
#[cfg(test)]
mod tests {
    use crate::{BindingKind, FunctionKind, FunctionMode, LoadBindingOp, ModuleIr, OperationKind};
